...
/**
 * Data source for the ProdutoList view. This class should
 * encapsulate all logic for fetching and manipulating the displayed data
 * (including sorting, pagination, and filtering).
 */
export class ProdutoListDataSource extends DataSource<any> {
  data: Produto[];
  ...
  connect(): Observable<Produto[]> {
    ...
    return merge(...dataMutations).pipe(map(() => {
      return this.getPagedData(this.getSortedData([...this.produto]));
    }));
  }
